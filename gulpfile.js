...
gulp.task('build', gulp.series(clean, 'exportCss', 'exportJs','exportVideo', 'exportImg', 'exportFonts', 'exportHTML'));

//Таск запускает таск build и watch  последовательно 
gulp.task('dev', gulp.parallel('js', 'css', 'styles',  'scripts', 'watch'));